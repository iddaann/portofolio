      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="grid gap-10 md:grid-cols-[48px_1fr] md:gap-8">
          <motion.div style={{ y: labelY }} className="flex items-start md:justify-center">
            <span className="text-[9px] uppercase tracking-[0.3em] text-white/35 [writing-mode:vertical-rl] md:text-[10px]">
              01 — Introduction
            </span>
          </motion.div>
          ...
          <div>
            <motion.h2
              ...
              className="max-w-4xl text-left text-[clamp(2.15rem,7vw,6rem)] font-medium leading-[0.98] tracking-[-0.055em] text-white"
            >
              I build digital experiences
              <span className="text-white/25"> that combine</span>{" "}
            ...
            <div className="mt-12 grid gap-8 sm:mt-16 md:grid-cols-[1fr_auto] md:items-end md:gap-12">
              ...
              >
                <p className="text-sm leading-7 text-white/45 sm:text-base sm:leading-8">
                  I&apos;m Muhamad Ramdhani Fathul Muttaqin, an Informatics student who enjoys turning ideas into useful digital products through software development and technology.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="hidden items-center gap-3 font-mono text-[8px] uppercase tracking-[0.2em] text-white/20 md:flex"
              >
            ...
            <motion.div
              ...
              className="mt-16 h-px w-24 origin-left bg-white/20 sm:mt-20"
            />
          </div>
        </div>
      </div>
